...
export default class Armor extends PhysicalItemData {
	...
	static defineSchema() {
		...
		return foundry.utils.mergeObject(super.defineSchema(), {
			/* leve | pesada | escudo */
			type: new fields.StringField({required: true, blank: true, choices: SYSTEM.armors, initial: "leve"}),
			...
			damageAbl: new fields.StringField({required: true, blank: false, choices: SYSTEM.abilities, initial: "str"}),
		})
	}
}
